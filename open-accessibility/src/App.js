  ...
  return (
    <div className="App">
      <header className="App-header text-white font-medium">
        ...
        <Formik
          enableReinitialize
          initialValues={initRef.current}
          onSubmit={(values, actions) => {
            chrome.storage.sync.set(values).then(() => {
              sendMsg({ action: "STATE_UPDATED", value: 0 });
            ...
            <form onSubmit={handleSubmit}>
              <div className="bg-white p-4 w-full min-h-screen rounded-t-2xl grid gap-4 grid-cols-2 grid-rows-6">
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("dyslexiaFonts", !values.dyslexiaFonts);
                    submitForm();
                  }}
                  enabledState={values.dyslexiaFonts}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    ...
                    let newCurrent = values.fontSize.current;

                    if (
                      newCurrent >=
                      values.fontSize.options[
                        values.fontSize.options.length - 1
                      ]
                    ) {
                      newCurrent = -1;
                    } else {
                    ...
                    setFieldValue("fontSize", {
                      current: newCurrent,
                      options: values.fontSize.options,
                    });
                    submitForm();
                  }}
                  enabledState={values.fontSize.current}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("desaturate", !values.desaturate);
                    submitForm();
                  }}
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("screenReader", !values.screenReader);
                    submitForm();
                  }}
                ...
                */}
                <SquareButton
                  ...
                  onClick={() => {
                    // Set the current word spacing to the next one in the array
                    let newCurrent = values.wordSpacing.current;

                    if (
                      newCurrent >=
                      values.wordSpacing.options[
                        values.wordSpacing.options.length - 1
                      ]
                    ) {
                      newCurrent = -1;
                    } else {
                    ...
                    setFieldValue("wordSpacing", {
                      current: newCurrent,
                      options: values.wordSpacing.options,
                    });
                    submitForm();
                  }}
                  enabledState={values.wordSpacing.current}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    // Set the current word spacing to the next one in the array
                    let newCurrent = values.lineHeight.current;

                    if (
                      newCurrent >=
                      values.lineHeight.options[
                        values.lineHeight.options.length - 1
                      ]
                    ) {
                      newCurrent = -1;
                    } else {
                    ...
                    setFieldValue("lineHeight", {
                      current: newCurrent,
                      options: values.lineHeight.options,
                    });
                    submitForm();
                  }}
                  enabledState={values.lineHeight.current}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("largeCursor", !values.largeCursor);
                    submitForm();
                  }}
                  enabledState={values.largeCursor}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("readingGuide", !values.readingGuide);
                    submitForm();
                  }}
                  enabledState={values.readingGuide}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("dyslexiaRuler", !values.dyslexiaRuler);
                    submitForm();
                  }}
                  enabledState={values.dyslexiaRuler}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("imageCaptioning", !values.imageCaptioning);
                    submitForm();
                  }}
                  enabledState={values.imageCaptioning}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("emphasizeLinks", !values.emphasizeLinks);
                    submitForm();
                  }}
                  enabledState={values.emphasizeLinks}
                />
                ...
                <SquareButton
                  ...
                  onClick={() => {
                    setFieldValue("animation", !values.animation);
                    submitForm();
                  }}
                  enabledState={values.animation}
                />
