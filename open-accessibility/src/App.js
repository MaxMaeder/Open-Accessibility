    ...
    <div className="App">
      <header className="App-header text-white font-medium">
        ...
        <div className="bg-white p-4 w-full min-h-screen rounded-t-2xl grid gap-4 grid-cols-2 grid-rows-6">
          ...
          <SquareButton text="Word Spacing" icon={<svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor" class="bi bi-distribute-horizontal mx-auto mt-4" viewBox="0 0 16 16">
          ...
          <SquareButton text="Line Height" icon={<svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor" class="bi bi-distribute-vertical mx-auto mt-4" viewBox="0 0 16 16">
